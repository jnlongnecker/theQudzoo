...
class Icon extends LightningElement {
  constructor(...args) {
    ...
    this.iconList = {
      ...
      filter: {
        path: "M1 0h22l-9 14.094v9.906l-4-2v-7.906z",
        viewBox: "0 0 24 24"
      },
      share: {
        path: "M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z",
        viewBox: "0 0 24 24"
      },
      question: {
        path: "M14.601 21.5c0 1.38-1.116 2.5-2.499 2.5-1.378 0-2.499-1.12-2.499-2.5s1.121-2.5 2.499-2.5c1.383 0 2.499 1.119 2.499 2.5zm-2.42-21.5c-4.029 0-7.06 2.693-7.06 8h3.955c0-2.304.906-4.189 3.024-4.189 1.247 0 2.57.828 2.684 2.411.123 1.666-.767 2.511-1.892 3.582-2.924 2.78-2.816 4.049-2.816 7.196h3.943c0-1.452-.157-2.508 1.838-4.659 1.331-1.436 2.986-3.222 3.021-5.943.047-3.963-2.751-6.398-6.697-6.398z",
        viewBox: "0 0 24 24"
      },
      warning: {
        path: "M12.866 3l9.526 16.5a1 1 0 0 1-.866 1.5H2.474a1 1 0 0 1-.866-1.5L11.134 3a1 1 0 0 1 1.732 0zM11 16v2h2v-2h-2zm0-7v5h2V9h-2z",
        viewBox: "0 0 24 24"
      },
      up: {
        path: "m296-224-56-56 240-240 240 240-56 56-184-183-184 183Zm0-240-56-56 240-240 240 240-56 56-184-183-184 183Z",
  ...
  get icon() {
    return this.useFlip ? this.iconList[this.flipvariant] : this.iconList[this.variant];
  }
  flip(event) {
...
_registerDecorators(Icon, {
  ...
  fields: ["animationClass", "useFlip", "iconList"]
});
