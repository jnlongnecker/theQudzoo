...
_registerDecorators(CodesTest, {
  fields: ["testCode", "mutantAp", "truekinAp", "baseJson"]
});
export default _registerComponent(CodesTest, {
  tmpl: _tmpl
});