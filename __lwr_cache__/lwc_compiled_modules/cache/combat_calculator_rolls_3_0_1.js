...
_registerDecorators2(Roll, {
  fields: ["tokens", "averageRoll"]
});
export { DiceRoll, Roll, getModifier, chanceForOneSuccess, chanceForThreeSuccess, chanceToSucceed, expectedPenetrations, rollPenetrations, random };