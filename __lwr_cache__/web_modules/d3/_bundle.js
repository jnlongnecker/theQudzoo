...
var Voronoi = class {
  ...
  render(context) {
    const buffer = context == null ? context = new path_default() : void 0;
...
var string_default2 = PathString;
...
function path_default2(projection2, context) {
  ...
  path2.context = function(_) {
    if (!arguments.length)
      return context;
    contextStream = _ == null ? (context = null, new string_default2(digits)) : new PathContext(context = _);
    if (typeof pointRadius !== "function")
  ...
  path2.digits = function(_) {
    ...
    if (context === null)
      contextStream = new string_default2(digits);
    return path2;
  };
