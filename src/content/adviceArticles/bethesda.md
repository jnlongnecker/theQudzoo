...
You can alternatively use some sort of forcefield to keep him at bay while you again either throw grenades at him or shoot at him, ideally with the carbine we received from the previous quest. Stopsvalinn is a near guaranteed source of a forcefield and while it doesn’t protect you fully, it should protect you for long enough for you to kill Jotun. You can find the location of this shield from the Barathrumites as a secret. Finally, if you managed to get the hologram bracelet or found one by other means, you can use it to distract Jotun again long enough for you to kill him. It works better the closer he is to the hologram and the further you are from the troll. Once Jotun is dead, you can take the key and advance to the next guardian.
