...
In an ideal world, you'll want your reputation with these factions to be at _least_ this value. Of course, realistically you won't hit these numbers which is the point of the above categories so you know which to prioritize. This section is to answer the question of “now that I know _what_ to go for, how far do I go?”. For most of these, the answer is to {{Y|neutral}} but for some you'll want to go above.
