...
import { attemptLogin, attemptRegister, logout, saveBuild, likeBuild, compileSugar } from './postRequests.js';
...
export {
    ...
    attemptLogin, attemptRegister, logout, saveBuild, likeBuild, compileSugar,
